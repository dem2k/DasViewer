...
/**
 * Physiche Darstellung des DAS Datensatzkopfes sowie der variablen DAS Teildatensätzte.
 *
...
public class SimpleDasSatz {
	...
	// Finanzamtsnummer (ohne Länderschlüssel, die letzten drei Stellen der
	// BUFA-Nr):
